...
[a tiny SQL-based swiss pairing tournament served using Python's `wsgiref` library](#mini-tournament).
And also [a Flask Python web framework SQLAlchemy using menu app.](#menu-app)
